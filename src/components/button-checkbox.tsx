...
const ButtonCheckbox = ({ styleText, radius, color, text, mode, checked, onChangeMode }: { styleText?: TextStyle, radius: number, color: string, text: string, mode: string | number, checked: boolean, onChangeMode: any }) => {
